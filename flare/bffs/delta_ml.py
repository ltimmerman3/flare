...
try:
    from .sgp._C_flare import Structure
...
class DeltaML_Calculator(Calculator):
    ...
    def __init__(self, sgp_calc, base_calculator = None, use_mapping=False):
        ...
        self.sgp_calc = sgp_calc
        self.gp_model = sgp_calc.gp_model
        self.results = {}
    ...
    def as_dict(self):
        ...
        out_dict.pop("atoms")
        out_dict.pop("base_calc")
        out_dict.pop("sgp_calc")
